...
*/ var _Scheduler_working = false;
    ...
    var $author$project$Main$Disconnected = {
        $: 'Disconnected'
    };
    var $author$project$Main$Server = F2(function(host, port_) {
        return {
            host: host,
            port_: port_
        };
    });
    var $author$project$Main$defaultAnsiState = {
    ...
    var $author$project$Main$Connecting = {
        $: 'Connecting'
    };
    ...
    var $author$project$Main$WebsocketStateChange = function(a) {
        return {
    ...
    var $author$project$Main$websocketStateReceiver = _Platform_incomingPort('websocketStateReceiver', $elm$json$Json$Decode$string);
    var $author$project$Main$subscriptions = function(_v0) {
        return $elm$core$Platform$Sub$batch(_List_fromArray([
            $author$project$Main$messageReceiver($author$project$Main$Recv),
            $author$project$Main$websocketStateReceiver(function(string) {
                switch(string){
                    case 'connecting':
                        return $author$project$Main$WebsocketStateChange($author$project$Main$Connecting);
                    case 'connected':
                        return $author$project$Main$WebsocketStateChange($author$project$Main$Connected);
                    case 'disconnected':
                        return $author$project$Main$WebsocketStateChange($author$project$Main$Disconnected);
                    default:
                        return $author$project$Main$WebsocketStateChange($author$project$Main$Disconnected);
                }
            })
    ...
    var $author$project$Main$connect = _Platform_outgoingPort('connect', function($1) {
        var a = $1.a;
        var b = $1.b;
        return A2($elm$json$Json$Encode$list, $elm$core$Basics$identity, _List_fromArray([
            function($2) {
                return $elm$json$Json$Encode$object(_List_fromArray([
                    _Utils_Tuple2('host', $elm$json$Json$Encode$string($2.host)),
                    _Utils_Tuple2('port_', function($) {
    ...
    var $author$project$Main$disconnect = _Platform_outgoingPort('disconnect', function($) {
        return $elm$json$Json$Encode$null;
    });
    var $author$project$Main$downloadMessages = _Platform_outgoingPort('downloadMessages', function($) {
        var a = $.a;
        var b = $.b;
        return A2($elm$json$Json$Encode$list, $elm$core$Basics$identity, _List_fromArray([
    ...
    var $author$project$Main$encodeMessage = function(message) {
        return A3($elm$core$List$foldl, F2(function(chunk, string) {
            if (chunk.$ === 'AnsiLinebreak') return string + '\n';
            else {
                var text = chunk.b;
                return _Utils_ap(string, text);
            }
        }), '', message.chunks);
    };
    ...
    var $author$project$Main$AnsiPrint = F2(function(a, b) {
        return {
            $: 'AnsiPrint',
            a: a,
            b: b
    ...
    var $vito$elm_ansi$Ansi$encodeCodes = function(codes) {
        return A2($elm$core$String$join, ';', A2($elm$core$List$map, $vito$elm_ansi$Ansi$encodeCode, codes));
    };
    var $vito$elm_ansi$Ansi$completeParsing = function(parser) {
        switch(parser.a.$){
            ...
            case 'CSI':
                ...
                var model = parser.b;
                var update = parser.c;
                return A2(update, $vito$elm_ansi$Ansi$Remainder('\u001B[' + $vito$elm_ansi$Ansi$encodeCodes(_Utils_ap(codes, _List_fromArray([
                    currentCode
                ])))), model);
            default:
                if (parser.a.a === '') {
    ...
    var $vito$elm_ansi$Ansi$Parser = F3(function(a, b, c) {
        return {
            $: 'Parser',
            a: a,
            b: b,
    ...
    var $vito$elm_ansi$Ansi$emptyParser = $vito$elm_ansi$Ansi$Parser($vito$elm_ansi$Ansi$Unescaped(''));
    var $vito$elm_ansi$Ansi$CSI = F2(function(a, b) {
        return {
            $: 'CSI',
            a: a,
            b: b
    ...
    var $vito$elm_ansi$Ansi$CarriageReturn = {
        $: 'CarriageReturn'
    };
    ...
    var $vito$elm_ansi$Ansi$Escaped = {
        $: 'Escaped'
    };
    var $vito$elm_ansi$Ansi$Linebreak = {
        $: 'Linebreak'
    };
    var $vito$elm_ansi$Ansi$RestoreCursorPosition = {
        $: 'RestoreCursorPosition'
    };
    var $vito$elm_ansi$Ansi$SaveCursorPosition = {
        $: 'SaveCursorPosition'
    };
    var $vito$elm_ansi$Ansi$Custom = F3(function(a, b, c) {
        return {
            $: 'Custom',
            a: a,
            b: b,
    ...
    var $vito$elm_ansi$Ansi$Black = {
        $: 'Black'
    };
    var $vito$elm_ansi$Ansi$Blue = {
        $: 'Blue'
    };
    var $vito$elm_ansi$Ansi$BrightBlack = {
        $: 'BrightBlack'
    };
    var $vito$elm_ansi$Ansi$BrightBlue = {
        $: 'BrightBlue'
    };
    var $vito$elm_ansi$Ansi$BrightCyan = {
        $: 'BrightCyan'
    };
    var $vito$elm_ansi$Ansi$BrightGreen = {
        $: 'BrightGreen'
    };
    var $vito$elm_ansi$Ansi$BrightMagenta = {
        $: 'BrightMagenta'
    };
    var $vito$elm_ansi$Ansi$BrightRed = {
        $: 'BrightRed'
    };
    var $vito$elm_ansi$Ansi$BrightWhite = {
        $: 'BrightWhite'
    };
    var $vito$elm_ansi$Ansi$BrightYellow = {
        $: 'BrightYellow'
    };
    var $vito$elm_ansi$Ansi$Green = {
        $: 'Green'
    };
    var $vito$elm_ansi$Ansi$Magenta = {
        $: 'Magenta'
    };
    ...
    var $vito$elm_ansi$Ansi$White = {
        $: 'White'
    };
    var $vito$elm_ansi$Ansi$Yellow = {
        $: 'Yellow'
    };
        ...
        switch(code){
            ...
            default:
                if (code >= 16 && code < 232) {
                    ...
                    return $elm$core$Maybe$Just(A3($vito$elm_ansi$Ansi$Custom, scale(r), scale(g), scale(b)));
                } else {
                    if (code >= 232 && code < 256) {
                        var c = (code - 232) * 10 + 8;
                        return $elm$core$Maybe$Just(A3($vito$elm_ansi$Ansi$Custom, c, c, c));
                    } else return $elm$core$Maybe$Nothing;
                }
        }
    };
    var $vito$elm_ansi$Ansi$captureArguments = function(list) {
        _v0$4: while(true){
            if (list.b) {
                if (list.b.b && list.b.b.b) switch(list.a){
                    case 38:
                        switch(list.b.a){
                            case 5:
                                var _v1 = list.b;
                                ...
                                var n = _v2.a;
                                var xs = _v2.b;
                                return A2($elm$core$List$cons, $vito$elm_ansi$Ansi$SetForeground($vito$elm_ansi$Ansi$colorCode(n)), $vito$elm_ansi$Ansi$captureArguments(xs));
                            case 2:
                                if (list.b.b.b.b && list.b.b.b.b.b) {
                                    ...
                                    return A2($elm$core$List$cons, $vito$elm_ansi$Ansi$SetForeground($elm$core$Maybe$Just(A3($vito$elm_ansi$Ansi$Custom, c(r), c(g), c(b)))), $vito$elm_ansi$Ansi$captureArguments(xs));
                                } else break _v0$4;
                            default:
                                break _v0$4;
                        }
                    case 48:
                        switch(list.b.a){
                            case 5:
                                ...
                                var n = _v4.a;
                                var xs = _v4.b;
                                return A2($elm$core$List$cons, $vito$elm_ansi$Ansi$SetBackground($vito$elm_ansi$Ansi$colorCode(n)), $vito$elm_ansi$Ansi$captureArguments(xs));
                            case 2:
                                if (list.b.b.b.b && list.b.b.b.b.b) {
                                    var _v9 = list.b;
                                    var _v10 = _v9.b;
                                    ...
                                    var xs = _v12.b;
                                    var c = A2($elm$core$Basics$clamp, 0, 255);
                                    return A2($elm$core$List$cons, $vito$elm_ansi$Ansi$SetBackground($elm$core$Maybe$Just(A3($vito$elm_ansi$Ansi$Custom, c(r), c(g), c(b)))), $vito$elm_ansi$Ansi$captureArguments(xs));
                                } else break _v0$4;
                            default:
                                break _v0$4;
                        }
    ...
    var $vito$elm_ansi$Ansi$completeBracketed = F2(function(_v0, actions) {
        var model = _v0.b;
        var update = _v0.c;
        return A3($vito$elm_ansi$Ansi$Parser, $vito$elm_ansi$Ansi$Unescaped(''), A3($elm$core$List$foldl, update, model, actions), update);
    });
    ...
    var $vito$elm_ansi$Ansi$CursorPosition = F2(function(a, b) {
        return {
            $: 'CursorPosition',
            a: a,
            b: b
    ...
    var $vito$elm_ansi$Ansi$EraseAll = {
        $: 'EraseAll'
    };
    var $vito$elm_ansi$Ansi$EraseToBeginning = {
        $: 'EraseToBeginning'
    };
    var $vito$elm_ansi$Ansi$EraseToEnd = {
        $: 'EraseToEnd'
    };
    ...
    var $vito$elm_ansi$Ansi$parseChar = F2(function(_char, parser) {
        switch(parser.a.$){
            case 'Unescaped':
                var str = parser.a.a;
                var model = parser.b;
                ...
                switch(_char){
                    case '\u000D':
                        return A3($vito$elm_ansi$Ansi$Parser, $vito$elm_ansi$Ansi$Unescaped(''), A2(update, $vito$elm_ansi$Ansi$CarriageReturn, $vito$elm_ansi$Ansi$completeUnescaped(parser)), update);
                    case '\n':
                        return A3($vito$elm_ansi$Ansi$Parser, $vito$elm_ansi$Ansi$Unescaped(''), A2(update, $vito$elm_ansi$Ansi$Linebreak, $vito$elm_ansi$Ansi$completeUnescaped(parser)), update);
                    case '\u001B':
                        return A3($vito$elm_ansi$Ansi$Parser, $vito$elm_ansi$Ansi$Escaped, $vito$elm_ansi$Ansi$completeUnescaped(parser), update);
                    default:
                        return A3($vito$elm_ansi$Ansi$Parser, $vito$elm_ansi$Ansi$Unescaped(_Utils_ap(str, _char)), model, update);
                }
            case 'Escaped':
                var _v2 = parser.a;
                var model = parser.b;
                var update = parser.c;
                if (_char === '[') return A3($vito$elm_ansi$Ansi$Parser, A2($vito$elm_ansi$Ansi$CSI, _List_Nil, $elm$core$Maybe$Nothing), model, update);
                else return A3($vito$elm_ansi$Ansi$Parser, $vito$elm_ansi$Ansi$Unescaped(_char), model, update);
            default:
                var _v4 = parser.a;
                var codes = _v4.a;
                ...
                switch(_char){
                    case 'm':
                        return A2($vito$elm_ansi$Ansi$completeBracketed, parser, $vito$elm_ansi$Ansi$captureArguments(A2($elm$core$List$map, $elm$core$Maybe$withDefault(0), _Utils_ap(codes, _List_fromArray([
                            currentCode
                        ])))));
                    case 'A':
                        return A2($vito$elm_ansi$Ansi$completeBracketed, parser, _List_fromArray([
                            $vito$elm_ansi$Ansi$CursorUp(A2($elm$core$Maybe$withDefault, 1, currentCode))
                        ]));
                    case 'B':
                        return A2($vito$elm_ansi$Ansi$completeBracketed, parser, _List_fromArray([
                            $vito$elm_ansi$Ansi$CursorDown(A2($elm$core$Maybe$withDefault, 1, currentCode))
                        ]));
                    case 'C':
                        return A2($vito$elm_ansi$Ansi$completeBracketed, parser, _List_fromArray([
                            $vito$elm_ansi$Ansi$CursorForward(A2($elm$core$Maybe$withDefault, 1, currentCode))
                        ]));
                    case 'D':
                        return A2($vito$elm_ansi$Ansi$completeBracketed, parser, _List_fromArray([
                            $vito$elm_ansi$Ansi$CursorBack(A2($elm$core$Maybe$withDefault, 1, currentCode))
                        ]));
                    case 'E':
                        return A2($vito$elm_ansi$Ansi$completeBracketed, parser, _List_fromArray([
                            $vito$elm_ansi$Ansi$CursorDown(A2($elm$core$Maybe$withDefault, 1, currentCode)),
                    ...
                    case 'G':
                        return A2($vito$elm_ansi$Ansi$completeBracketed, parser, _List_fromArray([
                            $vito$elm_ansi$Ansi$CursorColumn(A2($elm$core$Maybe$withDefault, 0, currentCode))
                        ]));
                    case 'H':
                        return A2($vito$elm_ansi$Ansi$completeBracketed, parser, $vito$elm_ansi$Ansi$cursorPosition(_Utils_ap(codes, _List_fromArray([
                            currentCode
                        ]))));
                    case 'J':
                        return A2($vito$elm_ansi$Ansi$completeBracketed, parser, _List_fromArray([
                            $vito$elm_ansi$Ansi$EraseDisplay($vito$elm_ansi$Ansi$eraseMode(A2($elm$core$Maybe$withDefault, 0, currentCode)))
                        ]));
                    case 'K':
                        return A2($vito$elm_ansi$Ansi$completeBracketed, parser, _List_fromArray([
                            $vito$elm_ansi$Ansi$EraseLine($vito$elm_ansi$Ansi$eraseMode(A2($elm$core$Maybe$withDefault, 0, currentCode)))
                        ]));
                    case 'f':
                        return A2($vito$elm_ansi$Ansi$completeBracketed, parser, $vito$elm_ansi$Ansi$cursorPosition(_Utils_ap(codes, _List_fromArray([
                            currentCode
                    ...
                    case ';':
                        return A3($vito$elm_ansi$Ansi$Parser, A2($vito$elm_ansi$Ansi$CSI, _Utils_ap(codes, _List_fromArray([
                            currentCode
                        ])), $elm$core$Maybe$Nothing), model, update);
                    default:
                        var c = _char;
                        var _v6 = $elm$core$String$toInt(c);
                        if (_v6.$ === 'Just') {
                            var num = _v6.a;
                            return A3($vito$elm_ansi$Ansi$Parser, A2($vito$elm_ansi$Ansi$CSI, codes, $elm$core$Maybe$Just(A2($elm$core$Maybe$withDefault, 0, currentCode) * 10 + num)), model, update);
                        } else return A2($vito$elm_ansi$Ansi$completeBracketed, parser, _List_Nil);
                }
        }
    });
    var $vito$elm_ansi$Ansi$parseInto = F3(function(model, update, ansi) {
        return $vito$elm_ansi$Ansi$completeParsing(A3($elm$core$List$foldl, $vito$elm_ansi$Ansi$parseChar, A2($vito$elm_ansi$Ansi$emptyParser, model, update), A2($elm$core$String$split, '', ansi)));
    });
    var $vito$elm_ansi$Ansi$parse = A2($elm$core$Basics$composeL, $elm$core$List$reverse, A2($vito$elm_ansi$Ansi$parseInto, _List_Nil, $elm$core$List$cons));
    var $author$project$Main$updateAnsiState = F2(function(action, state) {
        switch(action.$){
            case 'SetForeground':
                var color = action.a;
    ...
    var $author$project$Main$messageFromText = F2(function(initState, message) {
        var actions = $vito$elm_ansi$Ansi$parse(message);
        var _v0 = A3($elm$core$List$foldl, F2(function(action, _v1) {
            var state = _v1.a;
            var chunks = _v1.b;
            var remainder = _v1.c;
            var newState = A2($author$project$Main$updateAnsiState, action, state);
            var newRemainder = function() {
                if (action.$ === 'Remainder') {
                    var text = action.a;
                    return text;
                } else return remainder;
            }();
            var maybeChunk = function() {
                switch(action.$){
                    case 'Linebreak':
                        return $elm$core$Maybe$Just($author$project$Main$AnsiLinebreak);
                    case 'Print':
                        var text = action.a;
                        return $elm$core$Maybe$Just(A2($author$project$Main$AnsiPrint, newState, text));
                    default:
                        return $elm$core$Maybe$Nothing;
                }
            }();
            return _Utils_Tuple3(newState, function() {
                if (maybeChunk.$ === 'Nothing') return chunks;
                else {
                    var chunk = maybeChunk.a;
                    return _Utils_ap(chunks, _List_fromArray([
                        chunk
                    ]));
                }
            }(), newRemainder);
        }), _Utils_Tuple3(initState, _List_Nil, ''), actions);
        var finalState = _v0.a;
        var finalChunks = _v0.b;
        var finalRemainder = _v0.c;
        var finalMessage = {
            chunks: finalChunks,
            text: message
        };
    ...
    var $author$project$Main$update = F2(function(msg, model) {
        switch(msg.$){
            ...
            case 'DownloadMessages':
                var text = A3($elm$core$List$foldl, F2(function(message, string) {
                    return _Utils_ap(string, $author$project$Main$encodeMessage(message));
                }), '', model.messages);
                return _Utils_Tuple2(model, $author$project$Main$downloadMessages(_Utils_Tuple2(model.server.host, text)));
            case 'ColorSchemeToggled':
                return _Utils_Tuple2(_Utils_update(model, {
            ...
            case 'ServerChanged':
                ...
                var newServer = _Utils_update(server, {
                    host: host,
                    port_: maybePort
                });
                return _Utils_Tuple2(_Utils_update(model, {
            ...
            case 'Connect':
                var server = msg.a;
                var messages = _Utils_eq(model.server, server) ? model.messages : _List_Nil;
                return _Utils_Tuple2(_Utils_update(model, {
                    messages: messages,
                    server: server
                }), $author$project$Main$connect(_Utils_Tuple2(server, model.proxy)));
            case 'Disconnect':
                return _Utils_Tuple2(model, $author$project$Main$disconnect(_Utils_Tuple0));
            case 'DraftChanged':
                var text = msg.a;
                return _Utils_Tuple2(_Utils_update(model, {
                    draft: text
            ...
            case 'Send':
                if (!_Utils_eq(model.connectionState, $author$project$Main$Connected)) return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
                    ...
                    }), _Utils_eq(model.connectionState, $author$project$Main$Connected) ? $author$project$Main$sendMessage(model.draft + '\u000D\n') : $elm$core$Platform$Cmd$none);
                }
            case 'Recv':
                var message1 = msg.a;
                var result = A2($author$project$Main$messageFromText, model.ansiState, _Utils_ap(model.remainder, message1));
                return _Utils_Tuple2(_Utils_update(model, {
                    ...
                    messages: function() {
                        if (newState.$ === 'Disconnected') {
                            var style = _Utils_update($author$project$Main$defaultAnsiState, {
                                fg: $elm$core$Maybe$Just($vito$elm_ansi$Ansi$Red)
                            });
                            return _Utils_ap(model.messages, _List_fromArray([
                                A2($author$project$Main$messageFromText, style, '\nDisconnected.\n').message
                            ]));
                        } else return model.messages;
                    }()
                }), $elm$core$Platform$Cmd$none);
        }
    });
    ...
    var $author$project$Main$ansiStyles = function(state) {
        var colorStyles = F2(function(color, isForeground) {
            ...
            var brightClass = prefix + 'bright';
            switch(color.$){
                case 'White':
                    return _List_fromArray([
                        $elm$html$Html$Attributes$class(prefix + 'white')
                    ]);
                case 'Black':
                    return _List_fromArray([
                        $elm$html$Html$Attributes$class(prefix + 'black')
                    ]);
                case 'Red':
                    return _List_fromArray([
                        $elm$html$Html$Attributes$class(prefix + 'red')
                    ]);
                case 'Green':
                    return _List_fromArray([
                        $elm$html$Html$Attributes$class(prefix + 'green')
                    ]);
                case 'Yellow':
                    return _List_fromArray([
                        $elm$html$Html$Attributes$class(prefix + 'yellow')
                    ]);
                case 'Blue':
                    return _List_fromArray([
                        $elm$html$Html$Attributes$class(prefix + 'blue')
                    ]);
                case 'Magenta':
                    return _List_fromArray([
                        $elm$html$Html$Attributes$class(prefix + 'magenta')
                    ]);
                case 'Cyan':
                    return _List_fromArray([
                        $elm$html$Html$Attributes$class(prefix + 'cyan')
                    ]);
                case 'BrightWhite':
                    return A2($elm$core$List$cons, $elm$html$Html$Attributes$class(brightClass), A2(colorStyles, $vito$elm_ansi$Ansi$White, isForeground));
                case 'BrightBlack':
                    return A2($elm$core$List$cons, $elm$html$Html$Attributes$class(brightClass), A2(colorStyles, $vito$elm_ansi$Ansi$Black, isForeground));
                case 'BrightRed':
                    return A2($elm$core$List$cons, $elm$html$Html$Attributes$class(brightClass), A2(colorStyles, $vito$elm_ansi$Ansi$Red, isForeground));
                case 'BrightGreen':
                    return A2($elm$core$List$cons, $elm$html$Html$Attributes$class(brightClass), A2(colorStyles, $vito$elm_ansi$Ansi$Green, isForeground));
                case 'BrightYellow':
                    return A2($elm$core$List$cons, $elm$html$Html$Attributes$class(brightClass), A2(colorStyles, $vito$elm_ansi$Ansi$Yellow, isForeground));
                case 'BrightBlue':
                    return A2($elm$core$List$cons, $elm$html$Html$Attributes$class(brightClass), A2(colorStyles, $vito$elm_ansi$Ansi$Blue, isForeground));
                case 'BrightMagenta':
                    return A2($elm$core$List$cons, $elm$html$Html$Attributes$class(brightClass), A2(colorStyles, $vito$elm_ansi$Ansi$Magenta, isForeground));
                case 'BrightCyan':
                    return A2($elm$core$List$cons, $elm$html$Html$Attributes$class(brightClass), A2(colorStyles, $vito$elm_ansi$Ansi$Cyan, isForeground));
                default:
                    var r = color.a;
                    var g = color.b;
                    var b = color.c;
                    ...
                    return _List_fromArray([
                        A2($elm$html$Html$Attributes$style, attr, 'rgb(' + ($elm$core$String$fromInt(r) + (',' + ($elm$core$String$fromInt(b) + (',' + ($elm$core$String$fromInt(g) + ')'))))))
                    ]);
            }
        });
        return $elm$core$List$concat(_List_fromArray([
            function() {
                ...
                if (_v1.$ === 'Nothing') return _List_Nil;
                    ...
                    var color = _v1.a;
                    return A2(colorStyles, color, true);
                }
            }(),
            function() {
                var _v2 = state.bg;
                if (_v2.$ === 'Nothing') return _List_Nil;
                    ...
                    var color = _v2.a;
                    return A2(colorStyles, color, false);
                }
            }(),
            state.bold ? _List_fromArray([
                $elm$html$Html$Attributes$class('bold')
            ]) : _List_Nil,
            state.underline ? _List_fromArray([
                $elm$html$Html$Attributes$class('underline')
            ]) : _List_Nil,
            state.italic ? _List_fromArray([
    ...
    var $author$project$Main$viewMessage = function(message) {
        var chunkToElement = function(chunk) {
            if (chunk.$ === 'AnsiPrint') {
                var state = chunk.a;
                var text = chunk.b;
                var styles = $author$project$Main$ansiStyles(state);
                return $elm$core$List$isEmpty(styles) ? $elm$html$Html$text(text) : A2($elm$html$Html$span, styles, _List_fromArray([
                    $elm$html$Html$text(text)
                ]));
            } else return A2($elm$html$Html$br, _List_Nil, _List_Nil);
        };
        var chunkElements = A3($elm$core$List$foldl, F2(function(chunk, elements) {
            return _Utils_ap(elements, _List_fromArray([
                A2($elm$html$Html$Lazy$lazy, chunkToElement, chunk)
            ]));
    ...
    var $author$project$Main$Disconnect = {
        $: 'Disconnect'
    };
    var $author$project$Main$DownloadMessages = {
        $: 'DownloadMessages'
    };
    var $author$project$Main$ProxyChanged = function(a) {
        return {
            $: 'ProxyChanged',
            a: a
        };
    };
    var $author$project$Main$ServerChanged = F2(function(a, b) {
        return {
            $: 'ServerChanged',
            a: a,
            b: b
    ...
    var $author$project$Icon$downloadSvg = A2($elm$svg$Svg$svg, _List_fromArray([
    ...
    var $author$project$Main$isValidProxyUrl = function(text) {
        var regex = A2($elm$core$Maybe$withDefault, $elm$regex$Regex$never, $elm$regex$Regex$fromString('^ws://[^:]+(?::\\d+)?$'));
        return A2($elm$regex$Regex$contains, regex, text);
    };
    ...
    var $author$project$Icon$moonSvg = A2($elm$svg$Svg$svg, _List_fromArray([
        ...
        A2($elm$svg$Svg$path, _List_fromArray([
            $elm$svg$Svg$Attributes$d('M14 2C 9 2 3 7 3 15 3 23 9 29 17 29 25 29 30 23 30 18 19 25 7 13 14 2Z')
        ]), _List_Nil)
    ]));
    ...
    var $author$project$Main$viewTop = function(model) {
        return A2($elm$html$Html$div, _List_Nil, $elm$core$List$concat(_List_fromArray([
            _List_fromArray([
                A2($elm$html$Html$button, _List_fromArray([
                    $elm$html$Html$Events$onClick($author$project$Main$ColorSchemeToggled),
                    $elm$html$Html$Attributes$class('icon-button'),
                    $elm$html$Html$Attributes$title('Toggle dark mode'),
                    A2($elm$html$Html$Attributes$style, 'float', 'right')
                ]), _List_fromArray([
                    $author$project$Icon$moonSvg
                ])),
                A2($elm$html$Html$button, _List_fromArray([
                    $elm$html$Html$Events$onClick($author$project$Main$DownloadMessages),
                    A2($elm$html$Html$Attributes$style, 'float', 'right'),
                    $elm$html$Html$Attributes$class('icon-button'),
                    $elm$html$Html$Attributes$title('Download history'),
                    $elm$html$Html$Attributes$disabled($elm$core$List$isEmpty(model.messages))
                ]), _List_fromArray([
                    $author$project$Icon$downloadSvg
                ]))
            ]),
            function() {
                ...
                switch(_v0.$){
                    case 'Connecting':
                        return _List_fromArray([
                            A2($elm$html$Html$span, _List_fromArray([
                                $elm$html$Html$Attributes$class('fg-yellow')
                            ]), _List_fromArray([
                    ...
                    case 'Connected':
                        return _List_fromArray([
                            A2($elm$html$Html$span, _List_fromArray([
                                $elm$html$Html$Attributes$class('fg-green')
                            ]), _List_fromArray([
                                $elm$html$Html$text('Connected to ' + (model.server.host + (':' + (A2($elm$core$Maybe$withDefault, '23', A2($elm$core$Maybe$map, $elm$core$String$fromInt, model.server.port_)) + ' '))))
                            ])),
                            A2($elm$html$Html$button, _List_fromArray([
                    ...
                    default:
                        return _List_fromArray([
                            A2($elm$html$Html$span, _List_fromArray([
                                $elm$html$Html$Attributes$class('fg-red')
                            ]), _List_fromArray([
                                $elm$html$Html$text('Not connected ')
                            ])),
                            A2($elm$html$Html$button, _List_fromArray([
                                $elm$html$Html$Events$onClick($author$project$Main$Connect(model.server)),
                                $elm$html$Html$Attributes$disabled(!$author$project$Main$isValidProxyUrl(model.proxy))
                            ]), _List_fromArray([
                                $elm$html$Html$text('Connect')
                            ])),
                            $elm$html$Html$text(' '),
                            A2($elm$html$Html$input, _List_fromArray([
                                $elm$html$Html$Attributes$value(model.server.host),
                                $elm$html$Html$Attributes$placeholder('Host (e.g. example.com)'),
                                $elm$html$Html$Events$onInput(function(host) {
                                    return A2($author$project$Main$ServerChanged, host, model.server.port_);
                                })
                            ]), _List_Nil),
                            A2($elm$html$Html$input, _List_fromArray([
                                $elm$html$Html$Attributes$value(function() {
                                    var _v1 = model.server.port_;
                                ...
                                $elm$html$Html$Attributes$placeholder('Port (e.g. 23)'),
                                $elm$html$Html$Events$onInput(function(value) {
                                    return A2($author$project$Main$ServerChanged, model.server.host, $elm$core$String$toInt(value));
                                })
                            ]), _List_Nil),
                            A2($elm$html$Html$div, _List_fromArray([
                                ...
                                A2($elm$html$Html$span, _List_fromArray([
                                    $elm$html$Html$Attributes$class($author$project$Main$isValidProxyUrl(model.proxy) ? '' : 'blink fg-red')
                                ]), _List_fromArray([
                                    $elm$html$Html$text('Telnet proxy url: ')
                                ])),
                                A2($elm$html$Html$input, _List_fromArray([
                                    $elm$html$Html$Attributes$placeholder('e.g. http://localhost:8080'),
                                    $elm$html$Html$Events$onInput($author$project$Main$ProxyChanged),
                                    $elm$html$Html$Attributes$value(model.proxy)
                                ]), _List_Nil)
                            ])),
                            A2($elm$html$Html$div, _List_fromArray([
                                $elm$html$Html$Attributes$class('canned-servers')
                            ]), _List_fromArray([
                                A2($elm$html$Html$p, _List_Nil, _List_fromArray([
                                    $elm$html$Html$text('Or try these servers...')
                                ])),
                                A2($elm$html$Html$ul, _List_Nil, _List_fromArray([
                                    ...
                                    A2($elm$html$Html$li, _List_Nil, _List_fromArray([
                                        A2($elm$html$Html$button, _List_fromArray([
                                            $elm$html$Html$Events$onClick($author$project$Main$Connect(A2($author$project$Main$Server, 'aardmud.org', $elm$core$Maybe$Just(23))))
                                        ]), _List_fromArray([
                                            $elm$html$Html$text('Aardwolf')
                                        ])),
                                        A2($elm$html$Html$button, _List_fromArray([
                                            $elm$html$Html$Events$onClick($author$project$Main$Connect(A2($author$project$Main$Server, 'thresholdrpg.com', $elm$core$Maybe$Just(3333))))
                                        ]), _List_fromArray([
                                            $elm$html$Html$text('Threshold RPG')
                                        ])),
                                        A2($elm$html$Html$button, _List_fromArray([
                                            $elm$html$Html$Events$onClick($author$project$Main$Connect(A2($author$project$Main$Server, 'elephant.org', $elm$core$Maybe$Just(23))))
                                        ]), _List_fromArray([
                                            $elm$html$Html$text('Elephant')
                                        ]))
                                    ]))
                                ])),
                                A2($elm$html$Html$ul, _List_Nil, _List_fromArray([
                                    ...
                                    A2($elm$html$Html$li, _List_Nil, _List_fromArray([
                                        A2($elm$html$Html$button, _List_fromArray([
                                            $elm$html$Html$Events$onClick($author$project$Main$Connect(A2($author$project$Main$Server, 'rlmud.org', $elm$core$Maybe$Just(23))))
                                        ]), _List_fromArray([
                                            $elm$html$Html$text('Reinos de Leyenda')
                                        ]))
                                    ])),
                                    A2($elm$html$Html$li, _List_Nil, _List_fromArray([
                                        A2($elm$html$Html$button, _List_fromArray([
                                            $elm$html$Html$Events$onClick($author$project$Main$Connect(A2($author$project$Main$Server, 'cyberlife.es', $elm$core$Maybe$Just(7777))))
                                        ]), _List_fromArray([
                                            $elm$html$Html$text('Cyberlife')
                                        ]))
                                    ])),
                                    A2($elm$html$Html$li, _List_Nil, _List_fromArray([
                                        A2($elm$html$Html$button, _List_fromArray([
                                            $elm$html$Html$Events$onClick($author$project$Main$Connect(A2($author$project$Main$Server, 'mud.balzhur.org', $elm$core$Maybe$Just(5400))))
                                        ]), _List_fromArray([
                                            $elm$html$Html$text('Balzhur')
                                        ]))
                                    ])),
                                    A2($elm$html$Html$li, _List_Nil, _List_fromArray([
                                        A2($elm$html$Html$button, _List_fromArray([
                                            $elm$html$Html$Events$onClick($author$project$Main$Connect(A2($author$project$Main$Server, 'medinamud.ml', $elm$core$Maybe$Just(3232))))
                                        ]), _List_fromArray([
                                            $elm$html$Html$text('Medina')
                                        ]))
                                    ]))
                                ]))
                            ]))
    ...
    var $author$project$Main$view = function(model) {
        return A2($elm$html$Html$div, _List_fromArray([
            ...
            A2($elm$html$Html$div, _List_fromArray([
                ...
                $author$project$Main$viewTop(model)
            ])),
            A2($elm$html$Html$div, _List_fromArray([
                $elm$html$Html$Attributes$class('mid')
            ]), _List_fromArray([
                A2($elm$html$Html$pre, _List_Nil, A2($elm$core$List$concatMap, $author$project$Main$viewMessage, model.messages))
            ])),
            A2($elm$html$Html$div, _List_fromArray([
                ...
                A2($elm$html$Html$input, _List_fromArray([
                    ...
                    A2($elm$html$Html$Events$on, 'keydown', A2($elm$json$Json$Decode$andThen, function(key) {
                        if (key === 'Enter') return $elm$json$Json$Decode$succeed($author$project$Main$Send);
                        else return $elm$json$Json$Decode$fail('some other key');
                    }, A2($elm$json$Json$Decode$field, 'key', $elm$json$Json$Decode$string))),
                    $elm$html$Html$Attributes$value(model.draft),
                    $elm$html$Html$Attributes$placeholder('Write a command and enter...'),
    ...
    _Platform_export({
        'Main': {
            ...
            }, A2($elm$json$Json$Decode$field, 'isDarkMode', $elm$json$Json$Decode$bool)))(0)
        }
    });
})(this);

//# sourceMappingURL=index.41fbdb20.js.map
