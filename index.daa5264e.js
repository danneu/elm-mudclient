...
*/ var _Scheduler_working = false;
    ...
    var $author$project$Main$isValidProxyUrl = function(text) {
        var regex = A2($elm$core$Maybe$withDefault, $elm$regex$Regex$never, $elm$regex$Regex$fromString('^wss?://[^:]+(?::\\d+)?$'));
                    ...
                    default:
                        return _List_fromArray([
                            ...
                            A2($elm$html$Html$div, _List_fromArray([
                                ...
                                $elm$html$Html$text(' '),
                                A2($elm$html$Html$a, _List_fromArray([
                                    $elm$html$Html$Attributes$href('https://github.com/danneu/elm-mudclient')
                                ]), _List_fromArray([
...
//# sourceMappingURL=index.daa5264e.js.map
